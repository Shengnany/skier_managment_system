...
//    private static final String PATH = "/server_war_exploded/ski"; // LOCAL
    ...
    public static void main(String[] args) throws InterruptedException, FileNotFoundException {
        // LOCAL --num_threads 64 --num_skiers 128 --num_lifts 40 --num_runs 20 --ip_address localhost:8080
        // AWS   --num_threads 64 --num_skiers 128 --num_lifts 40 --num_runs 20 --ip_address localhost:8080
        ...
        // LOCAL http://localhost:8080/server_war_exploded/skiers
        // AWS   http://localhost:8080/server_war/skiers
